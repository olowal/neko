...
/*
uint16 size of the string
filename - cstring array
uint32 - size of this chunk so we can move to the next
!!make the following into a data struct!!
rmask - uint32
gmask - uint32
bmask - uint32
amask - uint32
...
height - int
bpp - int
SDL_PixelFormat (dont need to save this but..)
	SDL_Palette (This is a part of SDL_PixelFormat and I need so save colors (SDL_Color) and ncolors (int))
pixels - uint8 (find out size from w * h)
*/
